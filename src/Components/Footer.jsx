...
import {
  ...
  Instagram,
  MessageCircle,
} from "lucide-react"; // أيقونات من lucide
import { FaTiktok } from "react-icons/fa"; // أيقونة TikTok من react-icons
...
function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="bg-primary text-white py-12 px-6 md:px-20 font-cairo relative"
    >
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
        ...
        <div>
          ...
          <p className="mb-2 flex items-center gap-2">
            ...
            <a
              href="tel:+966536071891"
              className="hover:text-secondary text-white transition-all"
            >
              +966 53 607 1891
            </a>
          </p>
          ...
          <div className="flex gap-4 mt-4 text-xl">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hover:text-secondary text-background transition-all"
            >
        ...
        <div>
          ...
          <p className="mb-2 leading-relaxed">
            يعتمد المركز على منهجيات تعليمية متطورة تضمن للطلاب تحقيق
            تقدم مستمر في مهارات اللغة والتواصل.
          </p>
